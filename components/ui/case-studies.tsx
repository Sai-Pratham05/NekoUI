...
export default function Casestudies() {
  const caseStudies = [
    ...
    },
    {
      id: 2,
      quote:
        "Neko UI gave us a unified dashboard experience. Our ops team reduced time spent on context switching and improved clarity across all projects.",
      name: "Sophia Patel",
  ...
  return (
    <section
      className="pt-32 pb-7 px-0 bg-background"
